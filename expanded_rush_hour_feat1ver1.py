...
#FIRST FEATURE VER. 1: MANUALLY COMBINING PARTS OF EXAMPLE_EC_1 & EXAMPLE_EC_2 AND EXPANDING TO A 6X6 GRID
...
#This proves correctness for my problem implementation, but the search tree expands significantly with the 6x6 grid.
#One representational improvement guess of mine (that was later proved wrong) for my buggy/slow implementation is that I simply
#have occupies() for the two truck cells instead of actually having the rear and front block checked. This is adressed in the
#second version of feature 1.
