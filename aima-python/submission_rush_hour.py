...
def simple_rush_hour_manual():
    ...
    return ['MoveRight(R, C3_2, C3_3)', 'MoveRight(R, C3_3, C3_4)']
...
def complex_rush_hour_manual():
    ...
    return ['MoveUp(D, C3_2, C2_2)', 'MoveUp(E, C3_4, C2_4)', 'MoveRight(C, C3_3, C3_4)', 'MoveUp(A, C4_2, C3_2)', 'MoveUp(B, C4_3, C3_3)', 'MoveRight(R, C4_1, C4_2)', 'MoveRight(R, C4_2, C4_3)', 'MoveRight(R, C4_3, C4_4)']
...
def part_d():
    ...
    return [('a1', 'i3'), ('a2', 'i2'), ('a3', 'i1'), ('a4', 'i2')] 
